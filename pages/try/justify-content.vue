<template>
  <div>
    ...
    <div :style="{display: 'flex', backgroundColor: '#AAA', justifyContent: justifyContent, flexDirection: flexDirection, height: parentHeight}">
...
export default {
  ...
  computed: {
    parentHeight () {
      return this.flexDirection == 'row'? '': '500px'
    }
  }
}
</script>
